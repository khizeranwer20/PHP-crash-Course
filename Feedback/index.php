...
if (isset($_POST['submit'])) {
  ...
  if (empty($nameErr) && empty($emailErr) && empty($bodyErr)) {
    // add to database
    $sql = "INSERT INTO feedback (name, email, description) VALUES ('$name', '$email', '$body')";
...
?>
    ...
    <img src="/PHP-PRACTICE/PHP-crash-Course/Feedback/image/logo.png" class="w-25 mb-3" alt="">
    <h2>Feedback</h2>
    ...
    <form method="POST" action="<?php echo htmlspecialchars(
      ...
      <div class="mb-3">
        ...
        <textarea class="form-control <?php echo !$bodyErr ?:
          'is-invalid'; ?>" id="body" name="description" placeholder="Enter your feedback"><?php echo $body; ?></textarea>
      </div>
      <div class="mb-3">
